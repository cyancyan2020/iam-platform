...
func (_m *RoleRepository) Delete(ctx context.Context, id uint64) error {
...
func (_m *RoleRepository) FindByCode(ctx context.Context, code string) (*model.Role, error) {
...
func (_m *RoleRepository) FindByID(ctx context.Context, id uint64) (*model.Role, error) {
	ret := _m.Called(ctx, id)
	...
	var r0 *model.Role
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) (*model.Role, error)); ok {
		return rf(ctx, id)
	}
...
func (_m *RoleRepository) Update(ctx context.Context, role *model.Role) error {
	ret := _m.Called(ctx, role)
